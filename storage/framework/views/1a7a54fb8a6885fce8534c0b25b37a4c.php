    ...
    <div class="card border-0 shadow-sm">
      ...
      <div class="card-header d-flex flex-wrap gap-2 align-items-center justify-content-between">
        <div class="d-flex align-items-center gap-2">
          <span class="fw-semibold">รายละเอียดงาน #<?php echo e($report->id); ?></span>
          <button class="btn btn-light btn-sm px-2 py-1" data-bs-toggle="tooltip" title="คัดลอกหมายเลขงาน" id="btn-copy-id">
            <i class="far fa-copy"></i>
          </button>
        </div>
        <div class="d-flex flex-wrap gap-2 align-items-center">
          <span class="badge bg-<?php echo e($statusColor[$report->status] ?? 'secondary'); ?>"><?php echo e($report->status); ?></span>
          ...
          <div class="col-12 col-lg-7">
            ...
            <div class="mb-4">
              <dl class="row mb-0 small">
                ...
                <dd class="col-sm-8 col-lg-7 d-flex align-items-start gap-2">
                  <span id="device-address"><?php echo e($report->device_address); ?></span>
            ...
            <div class="mb-4 p-3 rounded-3 bg-light-subtle">
              ...
              <dl class="row mb-0 small">
                ...
                <dd class="col-sm-8"><?php echo e($techName); ?></dd>

                <?php if($aStatus): ?>
                  <dt class="col-sm-4 text-muted">สถานะ (ผู้รับผิดชอบ)</dt>
                  <dd class="col-sm-8"><span class="badge bg-info"><?php echo e($aStatus); ?></span></dd>
                <?php endif; ?>

                <dt class="col-sm-4 text-muted">รับงาน</dt>
                <dd class="col-sm-8"><?php echo e(optional($startedAt)->format('Y-m-d H:i') ?? '—'); ?></dd>

                <dt class="col-sm-4 text-muted">เสร็จสิ้น</dt>
                <dd class="col-sm-8"><?php echo e(optional($finishedAt)->format('Y-m-d H:i') ?? '—'); ?></dd>
              </dl>
            </div>
            ...
            <div class="mb-2">
              <div class="d-flex justify-content-between align-items-center mb-1">
                ...
                <small class="text-muted">
                  ...
                  <?php elseif($locked): ?>
                    (อ่านอย่างเดียว: รายการถูก <?php echo e($report->status); ?>)
                  <?php endif; ?>
                </small>
              </div>

              
              <div id="detail-display" class="small" style="white-space: pre-wrap;"><?php echo e($report->detail ?: '—'); ?></div>

              
              <form id="detail-form"
                    method="POST"
                    action="<?php echo e(route('report.updateDetail', $report)); ?>"
...
unset($__errorArgs, $__bag); ?> js-autosize"
                  name="detail"
                  rows="4"
                  style="white-space: pre-wrap; resize: vertical;"
                  <?php echo e((!$isOwner || $locked) ? 'disabled' : ''); ?>

                ><?php echo e(old('detail', $report->detail)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-2 d-flex flex-wrap gap-2">
                  <button type="submit" class="btn btn-success btn-sm" <?php echo e((!$isOwner || $locked) ? 'disabled' : ''); ?>>
              ...
              <div id="detail-actions" class="mt-2">
                <button type="button"
                        ...
                        title="<?php echo e((!$isOwner) ? 'ผู้สร้างเท่านั้นที่แก้ไขได้' : ($locked ? 'แก้ไขไม่ได้เพราะปิดงานแล้ว' : 'แก้ไขรายละเอียด')); ?>">
                  <i class="fa fa-pen me-1"></i> แก้ไข
                </button>
              </div>

              <?php if(session('success_detail')): ?>
                <div class="alert alert-success py-2 mt-3 mb-0"><?php echo e(session('success_detail')); ?></div>
              <?php endif; ?>
              <?php if($errors->any() && session('form') === 'update-detail'): ?>
          ...
          <div class="col-12 col-lg-5">
            <div class="d-flex align-items-center justify-content-between">
              ...
              <span class="badge rounded-pill bg-light text-dark"><?php echo e($report->images?->count() ?? 0); ?></span>
            </div>
                  ...
                  <div class="col-6 col-md-4">
                    <div class="position-relative">
                      <a href="<?php echo e($url); ?>"
                         ...
                         title="<?php echo e($img->original_name); ?>">
                        <div class="ratio ratio-4x3">
                          <img src="<?php echo e($url); ?>" alt="<?php echo e($img->original_name); ?>" loading="lazy" class="img-cover">
                        </div>
                      </a>

                      <?php if(($isOwner || $isAdmin) && !$locked): ?>
                        <form method="POST" action="<?php echo e(route('report.images.destroy', $img)); ?>"
            ...
            <?php if(($isOwner || $isAdmin) && !$locked): ?>
              <div class="card mt-3 border-0 shadow-sm">
                ...
                <div class="card-body">
                  <form method="POST" action="<?php echo e(route('report.images.store', $report)); ?>"
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      document.getElementById('btn-copy-id')?.addEventListener('click', () => copyText(String(<?php echo e($report->id); ?>)));
      ...
      const shouldEdit = "<?php echo e(session('form') === 'update-detail' && $errors->any() ? '1' : ''); ?>";
      ...
      if (dz && fileInput && grid && upForm) {
        ...
        upForm.addEventListener('submit', (e) => {
          ...
          btnUpload.disabled = true;
          fetch(upForm.action, { method: 'POST', body: fd, headers: {'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'} })
...
<?php endif; ?>
<?php /**PATH D:\code\Report\resources\views\report\show.blade.php ENDPATH**/ ?>